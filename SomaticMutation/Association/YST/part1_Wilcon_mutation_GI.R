...
Signature <- Signature[,c("AID","TotalSNV","TotalCNA","TotalSV","TotalTE")]
...
ggsave(file="./wilcox_Mutation_Mutation_part1.pdf", plot=figure_1,bg = 'white', width = 10, height = 16, units = 'cm', dpi = 600)
